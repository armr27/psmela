...
if (empty($_SESSION['admin'])) {
    ...
    if ($_SESSION['admin'] != 1 and $_SESSION['admin'] != 3) {
        ...
        if (isset($_REQUEST['act'])) {
            ...
            switch ($act) {
                case 'add':
                    include "page/tambah_surat_keluar.php";
                    break;
                case 'edit':
                    include "page/edit_surat_keluar.php";
                    break;
                case 'del':
                    include "page/hapus_surat_keluar.php";
                    break;
            }
        } else {
