...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if ($_REQUEST['tujuan'] == "" || $_REQUEST['isi_disposisi'] == "") {
            ...
            if (!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $tujuan)) {
                ...
                if (!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $isi_disposisi)) {
                    ...
                    $query = mysqli_query($config, "INSERT INTO tbl_disposisi(tujuan,isi_disposisi,id_surat,id_user)
                                        VALUES('$tujuan','$isi_disposisi','$id_surat','$id_user')");
                    $queryread = mysqli_query($config, "UPDATE tbl_surat_masuk SET notif = 1 WHERE id_surat = $id_surat");
                    if ($query == true && $queryread == true) {
